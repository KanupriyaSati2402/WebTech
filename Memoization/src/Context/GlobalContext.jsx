...
let deleteCart=(categoryType,id)=>{
  ...
  return (
    <Provider value={{deleteCart,cartData,setCartData,deleteCount,setDeleteCount,update,setUpdate,buyProduct,loginType,setLoginType,loginTypes,addProductPanel,setAddProductPanel}}>{children}</Provider>
  )
}
